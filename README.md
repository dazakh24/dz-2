...
| Администратор              | Модерация контента в рамках планируемой конференции |
| Фасилитатор              | Сбор обратной связи |
...
|--------|---------------------------------------|---------------------------------------|
| FR.001 | *Описание функционального требования* |*Описание функционального требования* |
