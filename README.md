...
|--------|------------------------------|------------------------------|-------------------------------------------|
| QR.001 | Пользователь ожидает не более | Вход в систему осуществляется менее 30 с. | *Описание требования к атрибуту качества* |
| QR.002 | Пользователь ожидает не более | Запуск трансляции не более 30 с. | *Описание требования к атрибуту качества* |
| QR.003 | Выступающий ожидает не более | Ознакомление контент менеджера с докладом не более 23 ч. | *Описание требования к атрибуту качества* |
| QR.004 | Выступающий ожидает не более | Обратная связь выступающему не более 24 ч. | *Описание требования к атрибуту качества* |
| QR.005 | Выступающий ожидает не более | Контент менеджер проставляет ретинг докладу и выступающему не более 23 ч. | *Описание требования к атрибуту качества* |
